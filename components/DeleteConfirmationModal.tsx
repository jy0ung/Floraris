...
const DeleteConfirmationModal: React.FC<DeleteConfirmationModalProps> = ({ onClose, onConfirm, plantName }) => {
  return (
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-md" onClick={e => e.stopPropagation()}>
        <div className="p-6">
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">
            This will permanently delete <span className="font-bold">{plantName}</span> and all its diary entries. This action cannot be undone.
          </p>
        </div>
